...
// echo 'http://' . $_SERVER['HTTP_HOST'];   видає елект адресу
...
if(!$conn) {
    ...
    while ($record = mysqli_fetch_assoc($result)) {
        ...
        <div class='m-5 p-2' style="border: solid black 2px">
            ...
            <p align=rigth> Коментарі:<?=$res_comm['CountComm']?></p>
            <div> 
            <p style="display: inline" onclick="addLike(<?=$record['Id']?>)">
                <img src="image/Like.png" alt="" style="width: 15px; height:auto; float:left">
                <span id="count<?=$record['Id']?>"><?=$record['Like']?></span>
            </p>
            <p style="display: inline" onclick="addDisLike(<?=$record['Id']?>)">
                <img src="image/DisLike.png" alt="" style="width: 15px; height:auto; float:left">
