...
<div id="container-nav">
  <nav class="navbar navbar-expand-lg navbar-light logot" id="nav">
    <a class="navbar-brand blog" href="index.php">BLOG</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link note" href="#">ЗАПИСИ<span class="sr-only">(current)</span></a>
        </li>
...
<div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
        <label for="exampleInputEmail1" class="email mt-5">Електронна адреса</label>
        <input type="email" class="form-control w-50" id="Email" aria-describedby="emailHelp" name="Email">
        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
    </div>

    <div class="form-group">
        <label for="exampleInputPassword1" class="email mt-3">Пароль</label>
